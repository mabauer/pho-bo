					...
					<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<header class="entry-header clear">
							...
							<div class="entry-meta">
								...
								<?php _e('Full size image: ', 'pho'); ?><span class="full-size-link"><a href="<?php echo wp_get_attachment_url(); ?>"><?php echo $metadata['width']; ?> &times; <?php echo $metadata['height']; ?></a></span>.
								<?php edit_post_link( __( 'Edit attachment post', 'pho' ), '<span class="edit-link">', '</span>.' ); ?>
							</div><!-- .entry-meta -->
						</header><!-- .entry-header -->
